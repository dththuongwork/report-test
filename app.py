...
def normalize_cols(df):
    ...
    # Danh sách các cột mục tiêu và các tên có thể có (ưu tiên từ trái sang phải)
    targets = {
        ...
        'Nhóm': ['nhóm'],
        'Loại': ['loại', 'phân loại'],
        'Ngày': ['ngày', 'thời gian', 'ngày tạo', 'created at', 'ngày đặt hàng'],
        'Số lượng': ['số lượng', 'sl', 'quantity'],
        'Thành tiền': ['thành tiền', 'doanh thu chi tiết', 'doanh thu', 'tổng tiền', 'thực thu'],
